      ...
      <section className="min-h-72"> 
        <div className="flex justify-center items-center gap-14">
          ...
          <div className="h-56 w-80 relative">
            ...
            <video id="video" src="https://assets.nflxext.com/ffe/siteui/acquisition/ourStory/fuji/desktop/video-tv-in-0819.m4v" autoPlay loop muted className="absolute box-border w-full top-[52px] right-0 pl-[32px]"></video>
          </div>
        </div>
